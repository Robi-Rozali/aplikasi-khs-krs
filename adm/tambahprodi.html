      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="#">Gedung</a>
            <a class="collapse-item" href="#">Grade Nilai</a>
            <a class="collapse-item" href="#">Kepala Bagian</a>
            <a class="collapse-item" href="#">Konsentrasi</a>
            <a class="collapse-item" href="#">Prodi</a>
            <a class="collapse-item" href="#">Ruangan</a>
            <a class="collapse-item" href="#">Tahun Angkatan</a>
          </div>
        </div>
      </li>
      <!-- Nav Item - Pages Collapse Menu -->
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="#">Biaya Kuliah</a>
            <a class="collapse-item" href="#">Form Pembayaran</a>
